...
| Campo | Valor |
|---|---|
| Repositorio | `rust_example_design_patterns` |
...
Demonstracao de padroes de projeto isolando regras de negocio da infraestrutura. Este documento descreve requisitos, arquitetura e criterios de aceite.
