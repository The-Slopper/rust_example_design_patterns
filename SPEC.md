# Especificacao Tecnica — Design Patterns

| Field | Value |
|---|---|
| Repository | `rust_example_design_patterns` |
| Language | Rust (Cargo) |
| Versao | 1.0 |
| Status | Ativo |
...
Demonstration of design patterns isolating business rules from infrastructure. This document describes requirements, architecture, and acceptance criteria.
